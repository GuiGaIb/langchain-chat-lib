 ...
 */
export declare abstract class BaseChatMemory extends BaseListChatMessageHistory {
    /**
    ...
    abstract addMessage(message: BaseMessage, fbMediaRefPath?: string): Promise<void>;
    abstract addMessages(messages: (BaseMessage & {
 ...
 */
export declare abstract class ChatMemoryWithSummary extends BaseChatMemory {
    /**
     ...
     * @returns \
     */
    getSummaryAsText(): Promise<string>;
    /**
...
export type SummaryChunk = string | {
    text: string;
